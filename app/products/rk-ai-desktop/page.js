                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ width: '100%' }}>
                        ...
                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px', justifyContent: 'center' }}>
                            <a href="https://github.com/robustkaryaai/arkis/releases/download/v2.0.0/RK-AI.dmg" download className="btn-primary" style={{
