...
const PRODUCTS = [
  ...
  {
    id: 'neytreya',
    category: 'Perceptual Intelligence',
    name: 'Neytreya',
    tagline: 'A local-first perceptual intelligence desktop watcher.',
    desc: 'Neytreya watches your screen every 10 seconds, understands what you are working on using a local Qwen3-VL vision model, tracks CPU/RAM/battery, and builds a searchable memory of your entire work history — entirely on your device.',
    tags: ['Local vision model', 'Recall memory', 'No cloud required'],
    color: '#6ee7b7',
    accent: '#10b981',
    badge: 'Beta v1.0',
    badgeDot: '#34d399',
  ...
  {
    id: 'venava',
    category: 'Personal Expression Layer',
    name: 'Venava',
    tagline: 'Your typing, amplified.',
    desc: 'A personal expression layer that learns how you naturally communicate so technology can sound like you, not replace you.',
    tags: ['Personal style', 'Private memory', 'Expression'],
    color: '#99f6e4',
    accent: '#14b8a6',
    badge: 'Expression layer',
    badgeDot: '#5eead4',
    href: '/products/venava',
    cta: 'Explore Venava',
    ctaIcon: <FiArrowRight />,
  },
{
  id: 'madhyn',
  category: 'Autonomous Environment',
  name: 'MADHYN',
  tagline: 'Your command center for autonomous development.',
  desc: 'An autonomous AI development environment that understands projects, researches problems, executes tasks, tests, iterates, and verifies results inside a controlled environment.',
  tags: ['Autonomous', 'Development', 'Controlled environment'],
  color: '#94a3b8',
  accent: '#cbd5e1',
