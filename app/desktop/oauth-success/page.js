...
const s = {
  main: { minHeight: "100vh", display: "grid", placeItems: "center", background: "#05070f", color: "#ffffff", fontFamily: "Inter, ui-sans-serif, system-ui, sans-serif", position: "relative", overflow: "hidden" },
  bgGlow: { position: "fixed", top: "50%", left: "50%", transform: "translate(-50%,-50%)", width: 600, height: 600, borderRadius: "50%", filter: "blur(120px)", pointerEvents: "none", zIndex: 0 },
  card: { textAlign: "center", padding: "48px 40px", display: "flex", flexDirection: "column", alignItems: "center", gap: 24, maxWidth: 500, position: "relative", zIndex: 1, background: "rgba(255,255,255,0.025)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 24, backdropFilter: "blur(20px)" },
  orbWrap: { position: "relative", width: 80, height: 80, display: "flex", alignItems: "center", justifyContent: "center" },
  orb: { width: 60, height: 60, borderRadius: "50%", opacity: 0.9, animation: "pulse 2s cubic-bezier(0.4,0,0.6,1) infinite", filter: "blur(3px)" },
  orbRing: { position: "absolute", inset: 0, borderRadius: "50%", border: "1.5px solid", opacity: 0.4, animation: "spin-slow 4s linear infinite" },
  title: { fontSize: 28, fontWeight: 800, margin: 0, letterSpacing: "-0.5px", color: "#ffffff" },
  sub: { color: "#a1a1aa", fontSize: 15, margin: 0, lineHeight: 1.6, maxWidth: 380 },
  loader: { display: "flex", gap: 8, alignItems: "center", marginTop: 4 },
  dot: { width: 7, height: 7, borderRadius: "50%", animation: "bounce 1.2s ease-in-out infinite", opacity: 0.8 },
  actions: { display: "flex", flexDirection: "column", gap: 12, width: "100%", alignItems: "center" },
  btn: { color: "#fff", padding: "14px 32px", borderRadius: 12, fontWeight: 700, fontSize: 15, border: "none", cursor: "pointer", width: "100%", maxWidth: 320, boxShadow: "0 8px 30px rgba(0,0,0,0.3)", transition: "opacity 0.15s" },
  manualLink: { color: "#a1a1aa", fontSize: 14, textDecoration: "underline", cursor: "pointer" },
  hint: { display: "flex", alignItems: "flex-start", gap: 10, background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: 10, padding: "12px 16px", fontSize: 13, color: "#a1a1aa", textAlign: "left", lineHeight: 1.55, maxWidth: 380 },
  hintIcon: { flexShrink: 0, fontSize: 15, opacity: 0.7, marginTop: 1 },
};
