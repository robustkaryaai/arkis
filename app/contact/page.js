...
import { FiMail, FiTwitter, FiMessageCircle } from 'react-icons/fi';
        ...
        <div style={{ background: 'var(--background)', color: 'var(--text)', minHeight: '100vh' }}>
            ...
            <section style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 5%' }}>
                ...
                <div style={{ display: 'flex', gap: '24px', marginTop: '60px', flexWrap: 'wrap' }}>
                    {[
                        [<FiMail size={24} />, 'Email', 'rexycoreofficial@gmail.com'], 
                        [<FiTwitter size={24} />, 'Twitter / X', '@rexycoreofficial'], 
                        [<FiMessageCircle size={24} />, 'Discord', 'Coming soon']
                        ...
                        <div key={label} className={`reveal reveal-delay-${i + 1}`} style={{ 
                            ...
                            <div>
                                <div style={{ fontSize: '11px', color: 'var(--muted)', fontWeight: '700', letterSpacing: '1.5px', textTransform: 'uppercase', marginBottom: '4px' }}>{label}</div>
                                <div style={{ fontSize: '16px', fontWeight: '600', color: 'var(--text)' }}>{val}</div>
                            </div>
                        </div>
                    ))}
                </div>
