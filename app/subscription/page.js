...
const PLANS = [
    ...
    },
    {
        ...
        type: 'waitlist',
        features: [
            '1080p High Quality Videos',
            '2 AI Videos / day',
            'Unlimited AI Images',
            '2 GB cloud storage',
            'Drive Integration',
            'Lifetime ₹300/mo locked',
        ],
    },
    {
        id: 'pro',
        ...
        popular: true,
        features: [
            'Custom Files Access (Let RK AI use them)',
            '5 AI Images / day & 3 Videos / day',
            '5 GB cloud storage',
            '7-day data retention',
            'API access & Priority support',
            'Minor internal additions',
            'Lifetime ₹550/mo locked',
        ],
    },
    {
        id: 'studio',
        ...
        features: [
            ...
            '10 GB cloud storage',
            'Unlimited retention',
            'Studio-grade generations',
            'Lifetime ₹700/mo locked',
        ],
    },
];
