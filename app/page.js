...
const PRODUCTS = [
  ...
  { id: 'neytreya',      color: '#6ee7b7', glow: 'rgba(16,185,129,0.5)',  icon: <FiActivity size={22} />, tag: 'System awareness',   name: 'Neytreya',         who: 'A clearer picture of your computer', tagline: 'Awareness, not conversation.', desc: 'Neytreya continuously understands the computer itself. It observes hardware usage, applications, workflows, and system behaviour locally. It is not a chatbot, coding assistant, or automation tool—its job is awareness.', href: '/products/neytreya' },
        ...
        <div style={W}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 18 }}>
            {[
              ...
              { from: 'Neytreya', fromC: '#6ee7b7', to: 'Your computer', toC: 'rgba(255,255,255,0.4)', desc: 'Neytreya observes hardware usage, applications, workflows, and system behaviour locally. It provides awareness, not conversation.' },
