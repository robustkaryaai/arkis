            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <form onSubmit={handleEmailSignup} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <div>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                                <label style={{ fontSize: '13px', fontWeight: '700', color: 'var(--subtext)', textTransform: 'uppercase' }}>Password</label>
                            </div>
                    ...
                    <div style={{ textAlign: 'center', marginTop: '32px', position: 'relative' }}>
                        ...
                        <span style={{ position: 'absolute', top: '-10px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(5,5,14,0.8)', padding: '0 12px', fontSize: '12px', color: 'var(--subtext)', fontWeight: '800', borderRadius: '99px', backdropFilter: 'blur(10px)' }}>OR</span>
                    </div>
                    ...
                    <button
                        ...
                        style={{
                            ...
                            cursor: 'pointer', transition: 'background 0.2s', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px',
